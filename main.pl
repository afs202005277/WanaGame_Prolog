...
% start_board(-Board:list(list(atom))) is det
...
% ai_level(+Option:integer, -Level:atom) is semidet
...
% get_all_moves_from_pos(+Board:list(list(atom)), +Coordinates:pair(integer), -Moves:list(pair(integer))) is det
...
% get_marble_position(+Player:atom, +Marble:atom, +Board:list(list(atom)), -Coordinates:pair(integer)) is det
...
% move(+Player:atom, +Marble:atom, +Board:list(list(atom)), +Coordinates:pair(integer), -NewBoard:list(list(atom))) is det
...
% check_all_moves(+Board:list(list(atom)), +Positions:list(pair(integer))) is det
...
% make_move(+Player:atom, +Board:list(list(atom)), -NewBoard:list(list(atom))) is det
...
% make_move_ai(+Difficulty:atom, +Player:atom, +Board:list(list(atom)), -NewBoard:list(list(atom))) is det
...
% game_cycle_wrapper(+GameMode:atom, +Board-Player:pair(list(list(atom)), atom)) is det
...
% game_over(+Board:list(list(atom)), +Player:atom) is det
...
% game_cycle(+GameMode:atom, +Board-Player:pair(list(list(atom)), atom)) is det
